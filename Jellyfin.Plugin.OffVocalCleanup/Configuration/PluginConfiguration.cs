...
public class PluginConfiguration : BasePluginConfiguration
{
    ...
    public PluginConfiguration()
    {
        ...
        OffVocalKeywords = "karaoke|カラオケ|offvocal|off vocal|off-vocal|オフボーカル|instrumental|instr.|インストゥルメンタル|accoustic|acoustic|acapella|アカペラ|orchestra|オーケストラ|tv size|tv ver";
    }
